...
func (r ApiCreateSubnetRequest) Execute() (CreateNetworkResponse, *_nethttp.Response, error) {
	return r.ApiService.CreateSubnetExecute(r)
}

/*
 * CreateSubnet Create subnet
 * Creates one or more subnets on the specified network. If async is true, a jobId will be returned.
READ permission required on cloud. CREATE_RESOURCES permission required on cloud. CREATE permission required on network.
 ...
 */
func (a *NetworksApiService) CreateSubnet(ctx _context.Context, network string) ApiCreateSubnetRequest {
	return ApiCreateSubnetRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
 ...
 * @return CreateNetworkResponse
 */
func (a *NetworksApiService) CreateSubnetExecute(r ApiCreateSubnetRequest) (CreateNetworkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v2/networks/{network}/subnets"
...
func (r ApiDeleteSubnetRequest) Cloud(cloud string) ApiDeleteSubnetRequest {
	r.cloud = &cloud
	return r
}

func (r ApiDeleteSubnetRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *NetworksApiService) DeleteSubnet(ctx _context.Context, network string, subnet string) ApiDeleteSubnetRequest {
	return ApiDeleteSubnetRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
 ...
 * Execute executes the request
 */
func (a *NetworksApiService) DeleteSubnetExecute(r ApiDeleteSubnetRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v2/networks/{network}/subnets/{subnet}"
	localVarPath = strings.Replace(localVarPath, "{"+"network"+"}", _neturl.PathEscape(parameterToString(r.network, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"subnet"+"}", _neturl.PathEscape(parameterToString(r.subnet, "")), -1)
...
func (r ApiGetSubnetRequest) Only(only string) ApiGetSubnetRequest {
	r.only = &only
	return r
}
func (r ApiGetSubnetRequest) Deref(deref string) ApiGetSubnetRequest {
	r.deref = &deref
	return r
}

func (r ApiGetSubnetRequest) Execute() (GetSubnetResponse, *_nethttp.Response, error) {
	return r.ApiService.GetSubnetExecute(r)
}

/*
 * GetSubnet Get subnet
 * Get details about target subnet
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param network
 * @param subnet
 * @return ApiGetSubnetRequest
 */
func (a *NetworksApiService) GetSubnet(ctx _context.Context, network string, subnet string) ApiGetSubnetRequest {
	return ApiGetSubnetRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
 ...
 */
func (a *NetworksApiService) GetSubnetExecute(r ApiGetSubnetRequest) (GetSubnetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiListSubnetsRequest) Cloud(cloud string) ApiListSubnetsRequest {
	r.cloud = &cloud
	return r
}
...
func (r ApiListSubnetsRequest) Start(start string) ApiListSubnetsRequest {
	r.start = &start
	return r
}
...
func (r ApiListSubnetsRequest) Only(only string) ApiListSubnetsRequest {
	r.only = &only
	return r
}
func (r ApiListSubnetsRequest) Deref(deref string) ApiListSubnetsRequest {
	r.deref = &deref
	return r
}

func (r ApiListSubnetsRequest) Execute() (ListSubnetsResponse, *_nethttp.Response, error) {
	return r.ApiService.ListSubnetsExecute(r)
}

/*
 * ListSubnets List subnets
 * List subnets owned by the active org. READ permission required on network & cloud.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param network
 * @return ApiListSubnetsRequest
 */
func (a *NetworksApiService) ListSubnets(ctx _context.Context, network string) ApiListSubnetsRequest {
	return ApiListSubnetsRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
 ...
 */
func (a *NetworksApiService) ListSubnetsExecute(r ApiListSubnetsRequest) (ListSubnetsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
