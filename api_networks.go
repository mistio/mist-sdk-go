...
func (r ApiCreateNetworkRequest) Execute() (*CreateNetworkResponse, *http.Response, error) {
...
func (a *NetworksApiService) CreateNetworkExecute(r ApiCreateNetworkRequest) (*CreateNetworkResponse, *http.Response, error) {
	var (
...
// Cloud the target network belongs to
...
*/
func (a *NetworksApiService) DeleteNetwork(ctx context.Context, network string) ApiDeleteNetworkRequest {
	return ApiDeleteNetworkRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
...
func (r ApiEditNetworkRequest) Execute() (*http.Response, error) {
...
*/
func (a *NetworksApiService) EditNetwork(ctx context.Context, network string) ApiEditNetworkRequest {
	return ApiEditNetworkRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
...
// Execute executes the request
func (a *NetworksApiService) EditNetworkExecute(r ApiEditNetworkRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkRequest) Execute() (*GetNetworkResponse, *http.Response, error) {
...
*/
func (a *NetworksApiService) GetNetwork(ctx context.Context, network string) ApiGetNetworkRequest {
	return ApiGetNetworkRequest{
		ApiService: a,
		ctx: ctx,
		network: network,
...
func (a *NetworksApiService) GetNetworkExecute(r ApiGetNetworkRequest) (*GetNetworkResponse, *http.Response, error) {
	var (
...
func (r ApiListNetworksRequest) Execute() (*ListNetworksResponse, *http.Response, error) {
...
func (a *NetworksApiService) ListNetworksExecute(r ApiListNetworksRequest) (*ListNetworksResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
