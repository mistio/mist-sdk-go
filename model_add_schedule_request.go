...
func (o *AddScheduleRequest) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AddScheduleRequest) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *AddScheduleRequest) HasType() bool {
	if o != nil && o.Type != nil {
		return true
	}
...
func (o *AddScheduleRequest) SetType(v string) {
	o.Type = &v
}
