...
func (o *CreateClusterRequest) GetTemplates() []interface{} {
...
// and a boolean to check if the value has been set.
func (o *CreateClusterRequest) GetTemplatesOk() ([]interface{}, bool) {
	if o == nil || o.Templates == nil {
		return nil, false
	}
...
func (o *CreateClusterRequest) SetTemplates(v []interface{}) {
	o.Templates = v
}
