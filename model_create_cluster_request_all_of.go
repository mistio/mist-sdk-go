...
func (o *CreateClusterRequestAllOf) GetTemplates() []interface{} {
...
// and a boolean to check if the value has been set.
func (o *CreateClusterRequestAllOf) GetTemplatesOk() ([]interface{}, bool) {
	if o == nil || o.Templates == nil {
		return nil, false
	}
...
func (o *CreateClusterRequestAllOf) SetTemplates(v []interface{}) {
	o.Templates = v
}
