 ...
 */
func (a *NameApiService) GetOrg(ctx _context.Context, org string) ApiGetOrgRequest {
	return ApiGetOrgRequest{
		ApiService: a,
		ctx: ctx,
		org: org,
 ...
 */
func (a *NameApiService) GetOrgExecute(r ApiGetOrgRequest) (GetOrgResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NameApiService.GetOrg")
	if err != nil {
