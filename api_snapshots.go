...
func (r ApiCreateSnapshotRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *SnapshotsApiService) CreateSnapshot(ctx context.Context, machine string) ApiCreateSnapshotRequest {
	return ApiCreateSnapshotRequest{
		ApiService: a,
		ctx: ctx,
		machine: machine,
...
func (a *SnapshotsApiService) CreateSnapshotExecute(r ApiCreateSnapshotRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
*/
func (a *SnapshotsApiService) ListSnapshots(ctx context.Context, machine string) ApiListSnapshotsRequest {
	return ApiListSnapshotsRequest{
		ApiService: a,
		ctx: ctx,
		machine: machine,
...
func (a *SnapshotsApiService) ListSnapshotsExecute(r ApiListSnapshotsRequest) (*ListSnapshotsResponse, *http.Response, error) {
	var (
...
func (r ApiRemoveSnapshotRequest) Execute() (*http.Response, error) {
...
*/
func (a *SnapshotsApiService) RemoveSnapshot(ctx context.Context, machine string, snapshot string) ApiRemoveSnapshotRequest {
	return ApiRemoveSnapshotRequest{
		ApiService: a,
		ctx: ctx,
		machine: machine,
...
// Execute executes the request
func (a *SnapshotsApiService) RemoveSnapshotExecute(r ApiRemoveSnapshotRequest) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"machine"+"}", url.PathEscape(parameterToString(r.machine, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"snapshot"+"}", url.PathEscape(parameterToString(r.snapshot, "")), -1)
...
func (r ApiRevertToSnapshotRequest) Execute() (*http.Response, error) {
...
*/
func (a *SnapshotsApiService) RevertToSnapshot(ctx context.Context, machine string, snapshot string) ApiRevertToSnapshotRequest {
	return ApiRevertToSnapshotRequest{
		ApiService: a,
		ctx: ctx,
		machine: machine,
...
// Execute executes the request
func (a *SnapshotsApiService) RevertToSnapshotExecute(r ApiRevertToSnapshotRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
