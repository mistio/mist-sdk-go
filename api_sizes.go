...
func (r ApiGetSizeRequest) Execute() (*GetSizeResponse, *http.Response, error) {
...
*/
func (a *SizesApiService) GetSize(ctx context.Context, size string) ApiGetSizeRequest {
	return ApiGetSizeRequest{
		ApiService: a,
		ctx: ctx,
		size: size,
...
func (a *SizesApiService) GetSizeExecute(r ApiGetSizeRequest) (*GetSizeResponse, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"size"+"}", url.PathEscape(parameterToString(r.size, "")), -1)
...
func (r ApiListSizesRequest) Execute() (*ListSizesResponse, *http.Response, error) {
...
*/
func (a *SizesApiService) ListSizes(ctx context.Context) ApiListSizesRequest {
	return ApiListSizesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SizesApiService) ListSizesExecute(r ApiListSizesRequest) (*ListSizesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
