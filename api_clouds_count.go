...
// CloudsCountApiService CloudsCountApi service
type CloudsCountApiService service

type ApiGetOrgRequest struct {
	ctx _context.Context
	ApiService *CloudsCountApiService
	org string
	only *string
	deref *string
}
 ...
 */
func (a *CloudsCountApiService) GetOrg(ctx _context.Context, org string) ApiGetOrgRequest {
	return ApiGetOrgRequest{
		ApiService: a,
		ctx: ctx,
		org: org,
 ...
 */
func (a *CloudsCountApiService) GetOrgExecute(r ApiGetOrgRequest) (GetOrgResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudsCountApiService.GetOrg")
	if err != nil {
