...
func (a *TagsApiService) ListTagsExecute(r ApiListTagsRequest) (*ListTagsResponse, *http.Response, error) {
	var (
...
func (r ApiTagResourcesRequest) Execute() (*http.Response, error) {
...
*/
func (a *TagsApiService) TagResources(ctx context.Context) ApiTagResourcesRequest {
	return ApiTagResourcesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *TagsApiService) TagResourcesExecute(r ApiTagResourcesRequest) (*http.Response, error) {
	var (
